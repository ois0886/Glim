...
import com.lovedbug.geulgwi.external.gpt.dto.ChatCompletionRequest;
import com.lovedbug.geulgwi.external.gpt.dto.ChatCompletionResponse;
import com.lovedbug.geulgwi.external.gpt.dto.ImageGenerationRequest;
import com.lovedbug.geulgwi.external.gpt.dto.ImageGenerationResponse;
...
public class OpenAIService {
    ...
    public byte[] generateImageBytes(String imgPrompt) {
        ...
        String b64 = imageGenerationResponse.getData().getFirst().getB64_json();
        if (b64 == null) {
