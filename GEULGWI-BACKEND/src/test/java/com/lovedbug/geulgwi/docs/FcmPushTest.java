...
public class FcmPushTest {
    ...
    @DisplayName("좋아요 등록 시 FCM 알림 전송")
    @Test
    void like_quote_send_fcm() {
    ...
    @DisplayName("자신의 글귀에 좋아요 시 FCM 알림 전송하지 않음")
    @Test
    void like_own_quote() {
    ...
    @DisplayName("FCM 서비스 예외 발생 시에도 좋아요는 정상 처리")
    @Test
    void like_quote_fcm_exception() {
